...
internal class IdentendringServiceTest {
    ...
    @Test
    internal fun `Oppdaterer alle aktive NL-koblinger hvis leder har byttet fnr`() {
    ...
    @Test
    internal fun `Oppretter aktive NL-koblinger med nytt fnr og bryter aktive koblinger med gammelt fnr hvis ansatt bytter fnr`() {
        testDb.connection.lagreNarmesteleder(
            orgnummer = "orgnummer",
            fnr = sykmeldtFnr,
            fnrNl = fnrLeder,
