...
class OppdaterNarmesteLederServiceTest :
    FunSpec({
        ...
        beforeTest {
            ...
            coEvery { pdlPersonService.getPersoner(any(), any()) } returns
                mapOf(
                    ...
                    Pair(
                        fnrLeder2,
                        PdlPerson(Navn("Leder", null, "Ledersen"), fnrLeder2, "aktorid2")
                    ),
                    Pair(
                        sykmeldtFnr,
                        PdlPerson(Navn("Syk", null, "Sykesen"), sykmeldtFnr, "aktorid3")
                    ),
                )
        }
        ...
        context("OppdaterNarmesteLederService") {
            ...
            test(
                "Deaktiverer tidligere nærmeste leder hvis ny leder meldes inn for samme orgnummer"
            ) {
                testDb.connection.lagreNarmesteleder(
                    orgnummer = "orgnummer",
                    fnr = sykmeldtFnr,
                ...
                coVerify(exactly = 1) {
                    narmesteLederLeesahProducer.send(
                        match {
                            it.narmesteLederFnr == fnrLeder && it.status == DEAKTIVERT_NY_LEDER
                        }
                    )
                }
                coVerify(exactly = 1) {
            ...
            test(
                "NlAvbrutt deaktiverer nærmeste leder og ber om ny NL hvis arbeidsforholdet er aktivt"
            ) {
            ...
            test(
                "NlAvbrutt deaktiverer nærmeste leder av leder og ber om ny NL hvis arbeidsforholdet er aktivt"
            ) {
                coEvery { arbeidsgiverService.getArbeidsgivere(any(), any(), any()) } returns
                    listOf(
                        Arbeidsgiverinfo(
            ...
            test(
                "NlAvbrutt deaktiverer nærmeste leder av arbeidstaker og ber ikke om ny leder hvis arbeidsforholdet er inaktivt"
            ) {
                coEvery { arbeidsgiverService.getArbeidsgivere(any(), any(), any()) } returns
                    listOf(
                        Arbeidsgiverinfo(
            ...
            test(
                "NlAvbrutt deaktiverer nærmeste leder av arbeidstaker og ber ikke om ny leder hvis arbeidsforhold ikke finnes i listen"
            ) {
                coEvery { arbeidsgiverService.getArbeidsgivere(any(), any(), any()) } returns
                    listOf(
                        Arbeidsgiverinfo(
            ...
            test(
                "NlAvbrutt feiler ikke hvis det ikke er noen ledere å deaktivere, og påvirker ikke nl for andre arbeidsforhold"
            ) {
                testDb.connection.lagreNarmesteleder(
